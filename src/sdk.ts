...
export class CapgoSDK {
  ...
  async addApp(options: AddAppOptions): Promise<SDKResult> {
    try {
      ...
      await addAppInternal(options.appId, internalOptions, undefined, false)
  ...
  async updateApp(options: UpdateAppOptions): Promise<SDKResult> {
    try {
      ...
      await setAppInternal(options.appId, internalOptions, false)
  ...
  async deleteBundle(appId: string, bundleId: string): Promise<SDKResult> {
    try {
      ...
      await deleteBundleInternal(bundleId, appId, internalOptions, false)
  ...
  async cleanupBundles(options: CleanupOptions): Promise<SDKResult<{ removed: number, kept: number }>> {
    try {
      ...
      const result = await cleanupBundleInternal(options.appId, internalOptions, false)
  ...
  async addChannel(options: AddChannelOptions): Promise<SDKResult> {
    try {
      ...
      await addChannelInternal(options.channelId, options.appId, internalOptions, false)
  ...
  async updateChannel(options: UpdateChannelOptions): Promise<SDKResult> {
    try {
      ...
      await setChannelInternal(options.channelId, options.appId, internalOptions, false)
  ...
  async deleteChannel(channelId: string, appId: string, deleteBundle = false): Promise<SDKResult> {
    try {
      ...
      await deleteChannelInternal(channelId, appId, internalOptions, false)
  ...
  async listChannels(appId: string): Promise<SDKResult<ChannelInfo[]>> {
    try {
      ...
      const channels = await listChannelsInternal(appId, internalOptions, false)
