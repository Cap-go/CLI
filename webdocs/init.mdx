...
If the local bundle ID already exists in your selected Capgo account, onboarding can reuse that app, delete and recreate it, or suggest a different bundle ID.
